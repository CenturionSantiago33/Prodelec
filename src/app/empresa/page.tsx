...
import { Award, Users, Globe, Leaf, ShieldCheck, CheckCircle2, ArrowRight } from "lucide-react";
      ...
      <section id="certificaciones" className="py-24 bg-navy-950 text-white relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-16">
            <div className="w-40 h-40 rounded-3xl bg-white/5 border border-white/10 flex items-center justify-center flex-col gap-3 backdrop-blur-md hover:border-electric transition-colors shadow-2xl">
              <ShieldCheck className="h-10 w-10 text-electric" />
              <span className="text-sm font-bold font-mono text-white">ISO 9001</span>
            </div>
            <div className="w-40 h-40 rounded-3xl bg-white/5 border border-white/10 flex items-center justify-center flex-col gap-3 backdrop-blur-md hover:border-electric transition-colors shadow-2xl">
              <ShieldCheck className="h-10 w-10 text-electric" />
              <span className="text-sm font-bold font-mono text-white">NORMA IRAM</span>
            </div>
            <div className="w-40 h-40 rounded-3xl bg-white/5 border border-white/10 flex items-center justify-center flex-col gap-3 backdrop-blur-md hover:border-electric transition-colors shadow-2xl">
              <ShieldCheck className="h-10 w-10 text-electric" />
              <span className="text-sm font-bold font-mono text-white">AGUA POTABLE</span>
            </div>
          </div>
